...
urlpatterns = [
    ...
    path('update-delivery/id=<id>', views.updateDeliveries.as_view(), name='update-delivery'),
    path('update-company/id=<id>', views.updateCompany.as_view(), name='update-company'),
    path('delivery/<paid>', views.deliveries.as_view(), name='delivery'),
    path('delivery/id=<id>', views.deliveries.as_view(), name='delivery'),
